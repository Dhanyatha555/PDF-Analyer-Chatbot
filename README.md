...
AI-powered PDF chatbot that uses Retrieval-Augmented Generation (RAG) to answer questions, summarize content, and extract insights from uploaded documents.

This project turns a local Ollama chatbot into a PDF Question Answering system using Ollama and ChromaDB.
